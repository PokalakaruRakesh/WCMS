...
public class VerifyMarketInsights_Innovation_WCMSI_593 extends BaseTest {
    ...
    public void validateMarketInsightsInnovationContent(){
        ...
        Assert.assertTrue(commonPage.ValidateLinkNewtab(marketInsiteInnovation.standardizationImpactReport,"https://marketing.astm.org/acton/fs/blocks/showLandingPage/a/9652/p/p-0403/t/page/fm/0","ASTM Standardization Impact","Standardization Impact Report Learn More CLicked"));
