...
public class ConfigReader {
	...
	public static String getValue(String key) {
		File file = new File("src\\main\\resources\\testResource\\config.properties");
	...
	{
		try {
        PropertiesConfiguration properties = new PropertiesConfiguration("src\\\\main\\\\resources\\\\testResource\\\\config.properties");
