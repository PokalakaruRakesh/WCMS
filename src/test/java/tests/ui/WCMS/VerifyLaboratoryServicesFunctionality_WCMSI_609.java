...
public class VerifyLaboratoryServicesFunctionality_WCMSI_609 extends BaseTest {
    ...
    public void ValidateLaboratoryPageContent() {
        try {
            ...
            Assert.assertTrue(commonPage.ValidateLinkNewtab(loborataryServicesPage.ProficiencyTestingLearnMore, "/proficiency-testing-program", "Proficiency Testing Program", "\'Proficiency Testing\'Learn more Link"));
            Assert.assertTrue(commonPage.ValidateLink(loborataryServicesPage.ReferenceMaterialsLearnMore, "/reference-materials", "Reference Materials", "\'Reference Materials\' Learn More Link"));
