...
public class VerifyStandardandSolutionOverview_WCMSI_505 extends BaseTest {
    ...
    public void validateStandardSolutionOverviewLinks() {
        try {
            ...
            Assert.assertTrue(commonPage.ValidateLink(Standard_SolutionOverview.ThirdPartyContentLearnMore, "/standards-and-solutions/enterprise-solutions/other-publishers", "", "\'Third-Party Content\' Learn More link"));
            ...
            Assert.assertTrue(commonPage.ValidateLink(Standard_SolutionOverview.CentersExcellenceLearnMore, "/standards-and-solutions/market-insights-and-innovation", "Market Insights and Innovation | ASTM", "\'Centers of Excellence\' Learn More Link"));
            Assert.assertTrue(commonPage.ValidateLinkNewtab(Standard_SolutionOverview.StandardizationImpactReportLearnMore, "https://marketing.astm.org/acton/fs/blocks/showLandingPage/a/9652/p/p-0403/t/page/fm/0", "ASTM Standardization Impact Report 2024", "\'Standardization Impact Report\' Learn More Link"));
