...
public class VerifyAboutPageNavigationFromHomePage_WCMSI_561 extends BaseTest {
    ...
    public void ValidateContent() {
        try {
            ...
            Assert.assertTrue(commonPage.ValidateLink(aboutPage.viewBtnUnderHistory, "/about/history", "History | ASTM", "View Button under History section"));
            //Validate view Button under Governance section
            Assert.assertTrue(commonPage.ValidateLink(aboutPage.viewBtnUnderGovernance, "/about/governance", "Governance | ASTM", "View Button under Governance section"));
            ...
            Assert.assertTrue(commonPage.ValidateLink(aboutPage.CultureCareersLearnMoreLink, "/about/careers", "Careers At ASTM International"));
            Assert.assertTrue(commonPage.ValidateLink(aboutPage.viewOpenOpportunitiesLink, "https://workforcenow.adp.com", "Recruitment"));
    ...
    public void NavigateToAboutPage() {
        try {
            ...
            Assert.assertEquals(driver.getTitle(), "About ASTM Overview | ASTM");
