...
public class CreateAccount_INT_999 extends BaseTest {
    ...
    @Description("Verify that a user can successfully create an account and see the confirmation message.")
    ...
    public void testCreateAccount_INT_999() {
        try {
            ...
            // Extract individual parameters (example fields, adjust as per actual JSON)
            ...
            Assert.assertTrue(createAccountPage.isConfirmationMessageDisplayed(), "Account confirmation message not displayed!");
        } catch (Exception e) {
            e.printStackTrace();
