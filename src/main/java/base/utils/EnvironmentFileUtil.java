...
public class EnvironmentFileUtil {
	static String filePath=System.getProperty("user.dir")+"//build//allure-results//environment.properties";
	...
	public static void generateEnvironmentPropFile()
	{
		...
		writePropToFile("TestEnvironmentURL", ConfigReader.getValue("BASE_URL_PUB_ASTM"));
		closefileStream();
	}
