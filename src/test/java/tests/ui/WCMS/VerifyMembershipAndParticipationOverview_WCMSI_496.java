...
public class VerifyMembershipAndParticipationOverview_WCMSI_496 extends BaseTest {
    ...
    public void validaMembershipAndParticipationLinks() {
        try {
            ...
            Assert.assertTrue(commonPage.ValidateLinkNewtab(MembershipAndParticipationOverview.DirectCommitteeParticipation, "/membership-participation/memberships", "ASTM Membership", "\'Direct Committee Participation\' Learn More link"));
            Assert.assertTrue(commonPage.ValidateLinkNewtab(MembershipAndParticipationOverview.PublicationDiscounts, "/standards-and-solutions/digital-library", "ASTM Digital Library", "\'Publication Discounts\' Learn More link"));
            Assert.assertTrue(commonPage.ValidateLinkNewtab(MembershipAndParticipationOverview.StandardizationNews, "/standardization-news", "STANDARDIZATION NEWS", "\'Standardization News\' Learn More link"));
            ...
            Assert.assertTrue(commonPage.ValidateLinkNewtab(MembershipAndParticipationOverview.MyCommittees, "https://secure.astm.org/?redirectUrl=aHR0cHM6Ly93d3cuYXN0bS5vcmcvc3NvL2xvZ2luL2F1dG8%3D&newApproach=true", "ASTM Login", "\'My Committees\' Learn More Link"));
            Assert.assertTrue(commonPage.ValidateLinkNewtab(MembershipAndParticipationOverview.ASTMCompass, "/standards-and-solutions/enterprise-solutions/astm-compass", "ASTM Compass", "\'ASTM Compass\' Learn More Link"));
            Assert.assertTrue(commonPage.ValidateLinkNewtab(MembershipAndParticipationOverview.GetPublished, "Publish-With-ASTM_1.pdf", "ASTM International Digital Library", "\'Sustainability Reference DatabaseGet Published\' Learn More Button"));
